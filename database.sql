...
--use tssi;
create table members(mid int auto_increment primary key,mname varchar(32),depts varchar(20),password varchar(32),modified bool);
insert into members values(null,'刘建坤','1','5d93ceb70e2bf5daa84ec3d0cd2c731a',false);
insert into members values(null,'赵雪娇','2','5d93ceb70e2bf5daa84ec3d0cd2c731a',false);
insert into members values(null,'田生军','3','5d93ceb70e2bf5daa84ec3d0cd2c731a',false);
insert into members values(null,'吕红波','4','5d93ceb70e2bf5daa84ec3d0cd2c731a',false);
